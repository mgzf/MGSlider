...
- (void)initialiseControl
{
    ...
    leftImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:self.sliderHammerImage]];
//    leftImageView.contentMode = UIViewContentModeScaleAspectFit;
    rightImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:self.sliderHammerImage]];
...
- (void)updateLabelValues
{
    ...
    if (self.selectedMinimum == self.minValue && !self.displayMaxMinValue)
    {
        ...
        self.minLabel.foregroundColor = [self.trackColor CGColor];
    }
    else
    {
        self.minLabel.string = [NSString stringWithFormat:@"%@", [formatter stringFromNumber:@(self.selectedMinimum)]];
        self.minLabel.foregroundColor = [UIColor colorWithRed:102.0 / 255.0 green:102.0 / 255.0 blue:102.0 / 255.0 alpha:1].CGColor;
    }

    if (self.selectedMaximum == self.maxValue && !self.displayMaxMinValue)
    {
        self.maxLabel.string = kBoundaryDispValue;
        self.maxLabel.foregroundColor = [self.trackColor CGColor];
    }
    else
    {
        self.maxLabel.string = [NSString stringWithFormat:@"%@", [formatter stringFromNumber:@(self.selectedMaximum)]];
        self.maxLabel.foregroundColor = [UIColor colorWithRed:102.0 / 255.0 green:102.0 / 255.0 blue:102.0 / 255.0 alpha:1].CGColor;
    }
}
...
//    self.maxLabel = label;
    ...
    leftImageView.image = [UIImage imageNamed:self.sliderHammerImage];
    rightImageView.image = [UIImage imageNamed:self.sliderHammerImage];
}
...
-(void)setSliderHammerImage:(NSString *)sliderHammerImage
{
    _sliderHammerImage = sliderHammerImage;
    leftImageView.image = [UIImage imageNamed:self.sliderHammerImage];
    //    leftImageView.contentMode = UIViewContentModeScaleAspectFit;
    rightImageView.image = [UIImage imageNamed:self.sliderHammerImage];
}
