...
- (void)initialiseControl
{
    ...
    leftImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"slider"]];
//    leftImageView.contentMode = UIViewContentModeScaleAspectFit;
    rightImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"slider"]];
...
//    self.maxLabel = label;
    ...
    leftImageView.image = [UIImage imageNamed:@"slider"];
    rightImageView.image = [UIImage imageNamed:@"slider"];
}
